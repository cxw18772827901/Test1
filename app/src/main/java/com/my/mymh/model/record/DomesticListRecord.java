...
public class DomesticListRecord {
    ...
    public static class Input extends BaseInput<DomesticListRecord> {

        public Input() {
            super(URL_END, Request.Method.POST, DomesticListRecord.class);
        }
        ...
        public static BaseInput<DomesticListRecord> buildInput(String lastId, String pageSize) {
