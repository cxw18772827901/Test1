...
//    public native int Log();
    ...
    private static Boolean MYLOG_SWITCH = false;// Config.GD_INFO_LOGS_ENABLED; // 日志文件总开�?
    private static Boolean MYLOG_WRITE_TO_FILE = true;// 日志写入文件�?��
    private static char MYLOG_TYPE = 'v';// 输入日志类型，w代表只输出告警信息等，v代表输出�?��信息
