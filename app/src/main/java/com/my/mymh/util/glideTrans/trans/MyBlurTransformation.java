package com.my.mymh.util.glideTrans.trans;
...
import com.my.mymh.util.glideTrans.internal.FastBlur;
import com.my.mymh.util.glideTrans.internal.RSBlur;
...
public class MyBlurTransformation implements Transformation {
    public static final String TAG = "com.dave.project.util.glideTrans.trans.MyBlurTransformation";
    ...
    @Override
    public Resource transform(Resource resource, int i, int i1) {
