...
public class ReadDialog {
    ...
    public static void showDialog(Context context, String titleMessage, String okMessage, String cancleMessage, View.OnClickListener okListener) {
        ...
        permisionDialog.setContentView(R.layout.read_dialog);
        ...
        tv_check.setOnClickListener(v -> {
            boolean selected = tv_check.isSelected();
            SPUtil.put(Constants.WIFI_SWITCH_NO_MORE, !selected);
