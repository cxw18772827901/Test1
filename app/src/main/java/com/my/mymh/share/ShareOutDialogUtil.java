...
public class ShareOutDialogUtil {
    ...
    public static void showDialog(Context context, boolean isCenter, ShareToListener shareToListener) {
        ...
        isCenters = isCenter;
        View convertView = View.inflate(context, isCenter ? R.layout.share_choose_dialog_center : R.layout.share_choose_dialog_out_bottom, null);
...
//                window.setWindowAnimations(R.style.main_menu_anim_center);//动画
    ...
    private static void initView() {
        ...
        dialog.findViewById(R.id.fl_close).setOnClickListener(click);
    }
