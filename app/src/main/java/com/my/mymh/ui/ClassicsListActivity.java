...
public class ClassicsListActivity extends BaseActivity {
    public static final String TAG = "ClassicsListActivity";
...
//                    IntentUtil.startActivity(ClassicsListActivity.this, CartoonInfoAndCatalogActivity.class);
                    IntentUtil.startRead(ClassicsListActivity.this, result);
                }
            }
        });
    ...
    private void initData() {
        ObjectRequest<HotOrNewCartoonListRecord> response = new ObjectRequest<>(false, HotOrNewCartoonListRecord.Input.buildInput(pageSize + "", page*pageSize + "", "7"),
