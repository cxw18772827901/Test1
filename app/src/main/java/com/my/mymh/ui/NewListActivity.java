...
public class NewListActivity extends BaseActivity {
    public static final String TAG = "NewListActivity";
...
//                    IntentUtil.startActivity(NewListActivity.this, CartoonInfoAndCatalogActivity.class);
                    IntentUtil.startRead(NewListActivity.this, result);
                }
            }
        });
    ...
    private void initData() {
        ObjectRequest<HotOrNewCartoonListRecord> response = new ObjectRequest<>(false, HotOrNewCartoonListRecord.Input.buildInput(pageSize + "", page * pageSize + "", "1"),
