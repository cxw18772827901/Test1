...
//                    IntentUtil.startActivity(HotListActivity.this, CartoonInfoAndCatalogActivity.class);
                    IntentUtil.startRead(HotListActivity.this, result);
                }
            }
        });
    ...
    private void initData() {
        ObjectRequest<HotOrNewCartoonListRecord> response = new ObjectRequest<>(false, HotOrNewCartoonListRecord.Input.buildInput(pageSize + "", lastId, "2"),
