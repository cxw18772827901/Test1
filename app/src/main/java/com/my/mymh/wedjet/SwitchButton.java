...
import com.my.mymh.util.ColorUtils;
 ...
 * @since 2014-09-24
 * <p>
 * <com.laiy.lyapp.widget.SwitchButton
 * android:id="@+id/switch_button"
 * android:layout_width="wrap_content"
 * android:layout_height="wrap_content"
 * android:layout_centerVertical="true"
 * android:layout_toLeftOf="@id/tv_price_view"
 ...
 * app:kswThumbMarginBottom="-19dp"
 * app:kswThumbMarginLeft="-16dp"
 * app:kswThumbMarginRight="-16dp"
 * app:kswThumbMarginTop="-19dp"
...
public class SwitchButton extends CompoundButton {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (mTintColor == 0) {
            ...
            boolean found = false;// getContext().getTheme().resolveAttribute(R.attr.colorAccent, typedValue, true);
            if (found) {
