package com.my.mymh.wedjet.smartrefresh.layout;
...
import com.my.mymh.wedjet.smartrefresh.layout.api.DefaultRefreshFooterCreator;
import com.my.mymh.wedjet.smartrefresh.layout.api.DefaultRefreshHeaderCreator;
import com.my.mymh.wedjet.smartrefresh.layout.api.RefreshContent;
import com.my.mymh.wedjet.smartrefresh.layout.api.RefreshFooter;
import com.my.mymh.wedjet.smartrefresh.layout.api.RefreshHeader;
import com.my.mymh.wedjet.smartrefresh.layout.api.RefreshInternal;
import com.my.mymh.wedjet.smartrefresh.layout.api.RefreshKernel;
import com.my.mymh.wedjet.smartrefresh.layout.api.RefreshLayout;
import com.my.mymh.wedjet.smartrefresh.layout.api.ScrollBoundaryDecider;
import com.my.mymh.wedjet.smartrefresh.layout.constant.DimensionStatus;
import com.my.mymh.wedjet.smartrefresh.layout.constant.RefreshState;
import com.my.mymh.wedjet.smartrefresh.layout.constant.SpinnerStyle;
import com.my.mymh.wedjet.smartrefresh.layout.footer.BallPulseFooter;
import com.my.mymh.wedjet.smartrefresh.layout.header.BezierRadarHeader;
import com.my.mymh.wedjet.smartrefresh.layout.impl.RefreshContentWrapper;
import com.my.mymh.wedjet.smartrefresh.layout.impl.RefreshFooterWrapper;
import com.my.mymh.wedjet.smartrefresh.layout.impl.RefreshHeaderWrapper;
import com.my.mymh.wedjet.smartrefresh.layout.listener.OnLoadMoreListener;
import com.my.mymh.wedjet.smartrefresh.layout.listener.OnMultiPurposeListener;
import com.my.mymh.wedjet.smartrefresh.layout.listener.OnRefreshListener;
import com.my.mymh.wedjet.smartrefresh.layout.listener.OnRefreshLoadMoreListener;
import com.my.mymh.wedjet.smartrefresh.layout.listener.OnStateChangedListener;
import com.my.mymh.wedjet.smartrefresh.layout.util.DelayedRunnable;
import com.my.mymh.wedjet.smartrefresh.layout.util.DensityUtil;
import com.my.mymh.wedjet.smartrefresh.layout.util.ScrollBoundaryUtil;
import com.my.mymh.wedjet.smartrefresh.layout.util.ViscousFluidInterpolator;
...
import static com.my.mymh.wedjet.smartrefresh.layout.util.DensityUtil.dp2px;
import static com.my.mymh.wedjet.smartrefresh.layout.util.SmartUtil.fling;
import static com.my.mymh.wedjet.smartrefresh.layout.util.SmartUtil.getColor;
import static com.my.mymh.wedjet.smartrefresh.layout.util.SmartUtil.isScrollableView;
...
//        this.mFooterExtendHeight = (int) Math.max((mFooterHeight * (mFooterMaxDragRate - 1)), 0);
    ...
    /**
     * 设置多功能监听器
     * @param listener 建议使用 {@link com.my.mymh.wedjet.smartrefresh.layout.listener.SimpleMultiPurposeListener}
     * @return SmartRefreshLayout
     */
    @Override
    ...
    /**
     * 设置滚动边界
     * @param boundary 建议使用 {@link com.my.mymh.wedjet.smartrefresh.layout.impl.ScrollBoundaryDeciderAdapter}
     * @return SmartRefreshLayout
     */
    @Override
